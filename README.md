...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p d70392b3-ba0c-4bd6-8522-4dcf584674c0
```

> `d70392b3-ba0c-4bd6-8522-4dcf584674c0` is the password of the certificate, you can change it to any password you want.
